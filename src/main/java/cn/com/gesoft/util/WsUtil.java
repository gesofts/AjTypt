...
public class WsUtil {
     ...
     * @return
     */
    public static  String getCityToGovMailXml(String param)
    {
    ...
    public static  String getCityGetGovLogisXml(String param)
    {
        String soapXML= "<?xml version=\"1.0\" encoding=\"utf-8\"?><soapenv:Envelope xmlns:soapenv='http://schemas.xmlsoap.org/soap/envelope/' xmlns:ser='http://service.cityToGovService.sparknet.com.cn/'><soapenv:Header/><soapenv:Body><ser:CityGetGovLogis><arg0>"+param+"</arg0></ser:CityGetGovLogis></soapenv:Body></soapenv:Envelope>";
        return soapXML;
    }
}
